...
//constructor that initializes the Automobil object
	Automobil(std::string combustibil = "", std::string caroserie = "", std::string tractiune = "", int putere = 0, std::string echipare = "", std::string* VIN = nullptr)
...
int main()
{
    ...
    Masina1 m3(m1);        // saul apeleaza astfel:
    Masina1 m4 = m1;

    Masina1 m5{ "benzina", "break", "spate", 56, "a5gh", VIN, "white" };
    //apel opeartorul=
    m1 = m5;    
